        ...
        responseHandler:(LeanplumStartBlock)startResponse
{
    ...
    [request onResponse:^(id<LPNetworkOperationProtocol> operation, NSDictionary *response) {
        ...
        NSMutableDictionary *messages = [response[LP_KEY_MESSAGES] mutableCopy];
        messages[@"5834936355913728"] = [messages[@"5834936355913728"] mutableCopy];
//         = messagesID;
        messages[@"5834936355913728"][@"vars"] = [messages[@"5834936355913728"][@"vars"] mutableCopy];
//        NSMutableDictionary *mutableDict = [messages[@"5834936355913728"][@"vars"] mutableCopy];
        messages[@"5834936355913728"][@"vars"][@"Notch V-Offset"] = @"60px";
//        messages[@"5834936355913728"][@"vars"] = mutableDict;
